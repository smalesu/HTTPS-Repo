...
sshpass -p ${Password} -o StrictHostKeyChecking=no scp -r /var/lib/jenkins/workspace/Deployment/target/java-tomcat-maven-example.war ${Username}@${IP_Address}:/u01/apache-tomcat-8.5.71/webapps
